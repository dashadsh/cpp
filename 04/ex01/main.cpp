...
/*   Updated: 2023/07/05 12:53:13 by dgoremyk         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main (void) 
{
    {
        /*
            This block of code tests the basic functionality of the Brain class and
            its integration with the Dog class. A Dog object named "brian" is created,
        ...
        */
        ...
        Dog brian;
        brian.setThought(0, "Is that bacon I smell?");
        brian.setThought(1, "Time to take another nap.");
        brian.makeSound();
        brian.setThought(2, "Wait, was that a squirrel?!");
        brian.setThought(3, "What if I never find out who's a good boy?");
        for (int i = 0; i < 4; i++)
            std::cout << "Dog's thought #" << i+1 << ": " << brian.getThought(i) << std::endl;
        for (int i = 4; i < 100; i++)
            brian.setThought(i, "I am dog, hear me bark!");
        std::cout << "Dog's thought #69: " << brian.getThought(68) << std::endl;
    }
    
    {
        /*
            This block of code tests the deep copy functionality of the Dog class. 
        ...
        */
        std::cout << std::endl << "--------------------------------------------------------------------------------" << std::endl;
        std::cout << "---------------------- test for deep copy of copy operator ---------------------" << std::endl;
        std::cout << "--------------------------------------------------------------------------------" << std::endl << std::endl;
        
        Dog braian;
        braian.setThought(0, "Who left this shoe here? Free chew toy!");
        Dog copyBraian = braian;
        copyBraian.makeSound();
        std::cout << "Copied Dog's thought #1: " << copyBraian.getThought(0) << std::endl;

        std::cout << std::endl << "----- change the original's thought and confirm it doesn't change the copy ----" << std::endl << std::endl;
		
        braian.setThought(0, "Is it dinner time yet?");
        std::cout << "Original Dog's thought #1: " << braian.getThought(0) << std::endl;
        std::cout << "Copied Dog's thought #1: " << copyBraian.getThought(0) << std::endl;
    }

    {
        ...
        */
        ...
        Dog braian;
        braian.setThought(0, "This tail just won't stop following me!");
        Dog copyBraian(braian);
        copyBraian.makeSound();
        std::cout << "Copied Dog's thought #1: " << copyBraian.getThought(0) << std::endl;
        ...
        braian.setThought(0, "I should bark at the mailman again.");
        std::cout << "Original Dog's thought #1: " << braian.getThought(0) << std::endl;
        std::cout << "Copied Dog's thought #1: " << copyBraian.getThought(0) << std::endl;
    }
	...
	{
    std::cout << std::endl << "--------------------------------------------------------------------------------" << std::endl;
    std::cout << "--------------------------  array of Animal obj 2 ------------------------------" << std::endl;
    std::cout << "--------------------------------------------------------------------------------" << std::endl << std::endl;
